...
func init() {
	auto.Register("bsd_dump", 30, func(p []byte, r storage.Reader, o auto.Options) (auto.View, error) {
		if !(len(p) >= 28 && (binary.BigEndian.Uint32(p[24:]) == 60012 || binary.LittleEndian.Uint32(p[24:]) == 60012)) {
